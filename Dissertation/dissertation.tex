...
%%% Use the following line as you write your dissertation
\documentclass{BGSU}  % compile with pdflatex


%%% The following lines could be used to use the axessibility package,
%%% if pdfLaTeX does not produce text that can be read by a screen reader
%%% Keep the lines in this unusual order
%\RequirePackage{pdfmanagement-testphase}
%\DeclareDocumentMetadata{pdfversion=1.7,lang=en-UK}
%\documentclass{BGSUaccessible}  % compile with lualatex
...
\subject{Algebra; statistics} % edit this for your area! Use broad terms
\keywords{Algebraic topology, Bayesian analysis} % be more specific here
